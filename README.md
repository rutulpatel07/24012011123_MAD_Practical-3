...
| :--- | :--- |
| <div align="center">![Practical 3 Demo](media/demo_video.webm)<br><i>(Demo Video)</i></div> | 1. **Web Browse**: Entered a URL and clicked "Browse" to open the browser.<br>2. **Phone Call**: Entered a number and clicked "Call" to open the dialer.<br>3. **Call Log**: Clicked "Call Log" to view recent calls (handled permission).<br>4. **Gallery**: Clicked "Gallery" to open the system photo picker.<br>5. **Camera**: Clicked "Camera" to capture an image.<br>6. **Set Alarm**: Clicked "Alarm" to set a 7:30 AM wake-up alarm.<br>7. **Login Navigation**: Clicked "Login" to navigate to the Login Activity. |
